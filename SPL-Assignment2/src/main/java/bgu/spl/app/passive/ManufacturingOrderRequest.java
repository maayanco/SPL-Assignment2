 ...
 * <p>
 * Its response type expected to be a Receipt. On the case the manufacture was
 * not completed successfully null should be returned as the request result.
 *
 */
public class ManufacturingOrderRequest implements Request<Receipt> {
	 ...
	 * 
	 * @param shoeType
	 *            - the type of shoe that should be manufactured
	 * @param amount
	 *            - the amount of shoes to be manufactured
	 * @param initialRequestTick
	 *            - the tick at which the initial request was issued
	 */
