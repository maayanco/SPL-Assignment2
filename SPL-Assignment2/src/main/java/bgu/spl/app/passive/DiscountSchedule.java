...
/**
 * An object which describes a schedule of a single discount that the manager
...
public class DiscountSchedule {
	...
	/**
	 * @param shoeType
	 *            - the type of the shoe that should be on discount
	 * @param tick
	 *            - the tick at which the discount should be occur
	 * @param amount
	 *            - the amount of shoes that should go on discount
	 */
