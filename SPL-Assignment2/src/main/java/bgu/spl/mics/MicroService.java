...
public abstract class MicroService implements Runnable {
	...
	private static final Logger log = Logger.getLogger(MicroService.class.getName());
	...
	/**
	 * the entry point of the micro-service. otherwise you will end up in an
	 * infinite loop.
	 */
	...
	public final void run() {
		...
		while (!terminated) {
			...
			try {
				...
				log.log(Level.WARNING, getName() + " received an InterruptionException ");
			}
		}
