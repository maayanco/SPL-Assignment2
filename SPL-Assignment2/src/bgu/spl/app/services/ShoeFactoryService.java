...
public class ShoeFactoryService extends MicroService {
	...
	/**
	 * Retrieves the first manufacturing order the factory received but hasn't
	 * finished yet (if exists) We decrease the number of shoes in this
	 * manufacturing order by 1. We check if the manufacturing order reached 0
	 * shoes - meaning it is finished. If so, create a new receipt and complete
	 * the manufacturing order with the receipt as it's result.
	 */
