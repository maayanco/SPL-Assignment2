...
public class TimeService extends MicroService{
	...
	/**
	 * 
	 * @param speed - the interval between every two ticks
	 * @param duration - ticks until TimeService should terminate
	...
	/**
	 * This method creates a timer (using a timertask) and set it to run at fixed rate (speed).
	 * 
	 */
	@Override
	...
	/** 
	 * This method handles TerminationBroadcasts, by starting a graceful termination of the TimeService. 
	 * Firstly It subscribes to TerminationBroadcasts. When a new termination broadcast is received,
	 * we invoke the end latch countDown to indicate the TimeService is terminating,
