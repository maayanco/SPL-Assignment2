 ...
 * <p>
 * Its response type expected to be a
...
public class RestockRequest implements Request<Boolean> {
	 ...
	 * @param amountRequested - the amount of shoes requested
	 * @param initialRequestTick - the tick at which the initial purchase request was initialized
	 */
